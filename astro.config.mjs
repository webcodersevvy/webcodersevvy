...
// TODO(domain): no domain purchased yet. Placeholder canonical.
// Replace with final domain when purchased, e.g. https://webcodersevvy.com
const SITE = "https://webcodersevvy.com";
